(function () {
  ...
  window.fetch = function (...args) {
    ...
    if (url.includes(window.BACKEND_URL) || url.startsWith('/api')) {
      config = config || {};
      if (!config.headers) {
        config.headers = {};
      }
  ...
  const DICT = {
    lo: {
      ...
      "feed.confirmDeleteComment": "ທ່ານຕ້ອງການລຶບຄຳເຫັນນີ້ຈິງບໍ?",
      "feed.commentEdited": "ແກ້ໄຂຄຳເຫັນສຳເລັດ",
      "feed.commentEditFailed": "ແກ້ໄຂຄຳເຫັນບໍ່ສຳເລັດ",
      "feed.commentDeleted": "ລຶບຄຳເຫັນສຳເລັດ",
      ...
      "feed.newPosts": "🆕 ມີ {count} ໂພສໃໝ່ — ກົດເພື່ອເບິ່ງ",
      ...
      "messages.send": "ສົ່ງ",
      "messages.sentSuccess": "ສົ່ງຂໍ້ຄວາມສຳເລັດ",
      "messages.editSuccess": "ແກ້ໄຂຂໍ້ຄວາມສຳເລັດ",
      "messages.deleteSuccess": "ລຶບຂໍ້ຄວາມສຳເລัด",
      ...
      "messages.confirmDeleteForEveryone": "ທ່ານຕ້ອງການລຶບຂໍ້ຄວາມນີ້ສຳລັບທຸກຄົນຈິງບໍ?",
      "messages.confirmDeleteForMe": "ທ່ານຕ້ອງການລຶບຂໍ້ຄວາມນີ້ສຳລັບທ່ານຄົນດຽວຈິງບໍ?",
      ...
      "profile.postDeleted": "ລຶບໂພສສຳເລັດ",
      "profile.deleteFailed": "ລຶບໂພສບໍ່ສຳເລັດ",
      "profile.postUpdated": "ອັບເດດໂພສສຳເລັດ",
    ...
    th: {
      ...
      "feed.confirmDeleteComment": "คุณต้องการลบคอมเมนต์นี้จริงหรือไม่?",
      "feed.commentEdited": "แก้ไขคอมเมนต์สำเร็จ",
      "feed.commentEditFailed": "แก้ไขคอมเมนต์ไม่สำเร็จ",
      "feed.commentDeleted": "ลบคอมเมนต์สำเร็จ",
      ...
      "feed.newPosts": "🆕 มี {count} โพสใหม่ — แตะเพื่อดู",
      ...
      "messages.send": "ส่ง",
      "messages.sentSuccess": "ส่งข้อความสำเร็จ",
      "messages.editSuccess": "แก้ไขข้อความสำเร็จ",
      "messages.deleteSuccess": "ลบข้อความสำเร็จ",
      ...
      "messages.confirmDeleteForEveryone": "คุณต้องการลบข้อความนี้สำหรับทุกคนจริงหรือไม่?",
      "messages.confirmDeleteForMe": "คุณต้องการลบข้อความนี้สำหรับคุณคนเดียวจริงหรือไม่?",
      ...
      "note.sentFriendRequest": "ส่งคำขอเป็นเพื่อนให้คุณ",
      "note.likedYourPost": "ถูกใจโพสต์ของคุณ",
      "note.commentedOnYourPost": "แสดงความคิดเห็นในโพสต์ของคุณ",
      "note.repliedToYourComment": "ตอบความคิดเห็นของคุณ",
      ...
      "profile.postDeleted": "ลบโพสต์สำเร็จ",
      "profile.deleteFailed": "ลบโพสต์ไม่สำเร็จ",
      "profile.postUpdated": "อัปเดตโพสต์สำเร็จ",
    ...
    en: {
      ...
      "feed.confirmDeleteComment": "Are you sure you want to delete this comment?",
      "feed.commentEdited": "Comment updated",
      "feed.commentEditFailed": "Failed to edit comment",
      "feed.commentDeleted": "Comment deleted",
      ...
      "feed.newPosts": "🆕 {count} new post(s) — tap to view",
      ...
      "messages.editSuccess": "Message updated successfully",
      ...
      "messages.confirmDeleteForEveryone": "Do you want to delete this message for everyone?",
      "messages.confirmDeleteForMe": "Do you want to delete this message for you only?",
      ...
      "note.sentFriendRequest": "sent you a friend request",
      "note.likedYourPost": "liked your post",
      "note.commentedOnYourPost": "commented on your post",
      "note.repliedToYourComment": "replied to your comment",
      ...
      "profile.postDeleted": "Post deleted successfully",
      "profile.deleteFailed": "Failed to delete post",
      "profile.postUpdated": "Post updated successfully",
